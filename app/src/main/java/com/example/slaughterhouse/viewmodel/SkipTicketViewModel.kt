...
@HiltViewModel
class SkipTicketViewModel @Inject constructor(private val apiRepository: Repository)  : ViewModel(){
    val result = MutableLiveData<Resource<Response<Unit>?>>()


    fun skipTicket(counter: String,
                      branchCode: String,
                      ticketNo: String,
                      userid: String,
                      ticketId: String){
        viewModelScope.launch {
            ...
            val response = apiRepository.skipTicket(counter, branchCode, ticketNo, userid, ticketId)
